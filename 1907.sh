#!/bin/bash
rm -rf openwrt/package/lean/luci-theme-argon  #删除源码自带的argon主题，因为最下面一个链接是增加了其他作者制作的argon主题
rm -rf openwrt/package/base-files/files/etc/banne
...
sed -i 's/OpenWrt/OpenWrt-123/g' package/base-files/files/bin/config_generate  #修改主机名字
