...
git clone https://github.com/lwz322/k3screenctrl.git package/lean/k3screenctrl  #k3组件
...
sed -i '/set luci.main.mediaurlbase=\/luci-static\/infinityfreedom/d' ./package/lean/luci-theme-infinityfreedom/root/etc/uci-defaults/30_luci-theme-infinityfreedom
