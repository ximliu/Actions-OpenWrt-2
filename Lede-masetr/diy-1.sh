...
svn co https://github.com/Lienol/openwrt/trunk/package/diy/luci-app-dockerman package/lean/luci-app-dockerman  #dockerman
svn co https://github.com/Lienol/openwrt/trunk/package/diy/luci-lib-docker package/lean/luci-lib-docker  #dockerman配套
