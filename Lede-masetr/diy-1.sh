...
rm -rf ./package/base-files/files/etc/banne && cd .. && cp -f ./x86-64/banner openwrt/package/base-files/files/etc/ && cd openwrt
...
svn co https://github.com/Lienol/openwrt/trunk/package/diy/luci-app-dockerman package/lean/luci-app-dockerman  #docker
svn co https://github.com/Lienol/openwrt/trunk/package/diy/luci-lib-docker package/lean/luci-lib-docker  #docker配套
